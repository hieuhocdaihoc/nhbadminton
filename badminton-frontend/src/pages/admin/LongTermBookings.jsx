...
const LongTermBookings = () => {
  ...
  const fetchInitData = useCallback(async (search = "") => {
    ...
    try {
      const [mastersRes, courtsRes] = await Promise.all([
        adminBookingService.getLongTermMasters(1, search),
  ...
  const handleSelectMaster = async (master) => {
    ...
    try {
      const res = await adminBookingService.getLongTermSessions(master.id);
  ...
  const requestAction = (sessionBooking, type) => {
    ...
    setConfirmModal({
      ...
      title,
      message: msg,
      actionData: { id: sessionBooking.id, payload, actionType },
    });
  };
        ...
        <div className="col-span-4 admin-card border-none flex flex-col min-h-0 overflow-hidden">
          <div className="shrink-0 px-4 py-3 border-b border-zinc-100">
            <div className="flex items-center gap-2 mb-2.5">
              ...
              <h2 className="text-sm font-semibold text-zinc-800">Hợp đồng dài hạn</h2>
            </div>
              ...
              sortedMasters.map((m) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full p-3 rounded-lg border text-left transition-all duration-150 ${
                      isSelected
                        ...
                        : "bg-white border-zinc-100 hover:border-amber-200 hover:bg-amber-50/30"
                    } ${
                  ...
                  >
                    ...
                    <p className={`text-[11px] mt-0.5 ${isSelected ? "text-amber-100" : "text-zinc-500"}`}>
                      {m.user?.phone || "N/A"}
                    </p>
        ...
        <div className="col-span-8 admin-card border-none flex flex-col min-h-0 overflow-hidden">
          <div className="shrink-0 px-5 py-3.5 border-b border-zinc-100 flex justify-between items-center">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-amber-50 flex items-center justify-center text-amber-600 font-semibold text-xs shrink-0 border border-amber-100">
              ...
              <div>
                ...
                {selectedMaster && (
                  <div className="flex items-center gap-2 mt-0.5 text-[11px] text-zinc-400">
                    ...
                    <span>·</span>
                    <span className="text-amber-600 font-medium">Dài hạn (tự chọn ngày)</span>
                    <span>·</span>
                    <span className="font-mono">
          ...
          <div className="flex-1 overflow-auto">
            <table className="w-full text-left text-xs whitespace-nowrap">
              ...
              <tbody>
                {!selectedMaster ? (
                  <tr>
                    <td colSpan="6" className="py-20 text-center text-xs text-zinc-300">
                  ...
                  <tr>
                    <td colSpan="6" className="py-20 text-center">
                      <div className="inline-block w-5 h-5 border-2 border-amber-200 border-t-amber-500 rounded-full animate-spin" />
                    </td>
                  </tr>
                ) : (
            ...
            >
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="admin-btn-primary bg-amber-600 hover:bg-amber-700 border-transparent text-white flex-1 py-2.5 text-xs font-medium"
                >
            ...
            >
              ...
              <form onSubmit={handleRescheduleSubmit} className="p-6 space-y-4">
                ...
                <div className="flex gap-2 pt-3 border-t border-zinc-100">
                  <button
                    type="button"
                    onClick={() => setRescheduleModal({ isOpen: false, detailId: null, booking: null })}
                    className="admin-btn-outline flex-1 py-2.5 text-xs font-medium"
                  >
                    Hủy
                  </button>
