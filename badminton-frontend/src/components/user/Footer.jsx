...
const Footer = () => {
    const quickLinks = [
        ...
        { name: 'Sơ đồ mặt bằng', href: '/#courts' },
    ...
    const openHours = [
        { day: 'Thứ 2 - Thứ 6', time: '05:00 - 23:00' },
        { day: 'Thứ 7 - Chủ nhật', time: '06:00 - 23:00' },
        { day: 'Ngày lễ / Tết', time: '07:00 - 22:00' },
    ];
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 pb-16 border-b border-zinc-800/60">
                    ...
                    <div className="lg:col-span-4">
                        <div className="flex items-center gap-2.5 mb-5">
                            ...
                            <span className="font-extrabold text-xl tracking-tight text-white">Badminton<span className="text-lime-400">.</span></span>
                        </div>
                        <p className="text-zinc-500 text-sm leading-relaxed mb-6 max-w-xs">
                            Hệ thống đặt lịch và quản lý sân cầu lông chuyên nghiệp. Giải pháp chuyển đổi số tối ưu hóa trải nghiệm cho mọi vợt thủ.
                        </p>
                    ...
                    <div className="lg:col-span-3">
                        ...
                        <div className="space-y-4 text-sm">
                            <div className="flex items-start gap-3 group">
                                ...
                                <span className="group-hover:text-zinc-300 transition-colors">1000 ấp 3 xã phước kiển huyện nhà bè</span>
                            </div>
                            <div className="flex items-center gap-3 group">
                                ...
                                <span className="text-lime-400 font-semibold group-hover:text-lime-300 transition-colors">0394.421.192</span>
                            </div>
                            <div className="flex items-center gap-3 group">
                                ...
                                <span className="group-hover:text-zinc-300 transition-colors">ngochieu21192@gmail.com</span>
                            </div>
                        </div>

                        {/* Mini map placeholder */}
                        <div className="mt-5 rounded-xl overflow-hidden border border-zinc-800/60 h-[100px] bg-zinc-900/50 flex items-center justify-center">
                            <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer"
                                className="text-xs text-zinc-500 hover:text-lime-400 transition-colors font-semibold flex items-center gap-1.5">
